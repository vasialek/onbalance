...
namespace OnBalance.Helpers
{
    ...
    {
        private static string scriptIncludesKey = "OnBalance.Helpers.SimpleScriptManager.Includes";
        private static string scriptsKey = "OnBalance.Helpers.SimpleScriptManager.Scripts";
        ...
        public SimpleScriptManager IncludeLibrary(Libraries library, string version, ScriptFormats f, Cdns cdn)
        {
            ...
            if( library == Libraries.UnobtrusiveMvc )
            {
                ...
                this.scriptIncludes.Add(library.ToString().ToLower(), string.Concat("//ajax.aspnetcdn.com/ajax/mvc/3.0/", jsFilename));
                return this;
            }
            string baseUrl = cdn == Cdns.Google ? "//ajax.googleapis.com/ajax/libs/" : "//ajax.aspnetcdn.com/ajax/";
            this.scriptIncludes.Add(library.ToString().ToLower(), string.Format("{0}{1}", baseUrl, jsFilename));
            return this;
        }
        ...
        //    return GetResourceUrl<T>(null, resourceName);
        //}
